  ...
  return {
    pages: {
      home: {
        ...
        eyebrow: 'Women & Children Development Initiative(WCDI)',
        icon: 'fa-hands-helping',
        backgroundImage: featuredImages.hero
      },
      about: {
        title: 'About Women and Children Development Initiative (WCDI)',
      ...
      blog: {
        title: 'News & Stories',
        text: 'Read updates, field notes, and volunteer stories from Women and Children Development Initiative (WCDI) programs.',
        eyebrow: 'Latest Updates',
        icon: 'fa-newspaper'
      }
    },
    about: {
      sectionTitle: 'Making a Difference Since 2018',
    ...
    team: [
      { 
        ...
        bio: 'Leads WCDI strategy, partnerships, and community-centered program growth.', 
        image: ceoImage, 
      ...
      { 
        ...
        bio: 'Coordinates education, health, and outreach initiatives with local partners.', image: womenImage, 
        linkedin: 'https://www.linkedin.com/' },
      { 
        name: 'Matthew Deng Goch', 
        role: 'Youth Engagement Lead', 
        bio: 'Supports youth mentorship, volunteer mobilization, and field activities.', 
        image: youthImage, 
        linkedin: 'https://www.linkedin.com/' 
      }
    ],
    testimonials: [
      { 
        ...
        quote: 'WCDI helped my children return to school with confidence and the supplies they needed.', 
        image: ceoTestimonialImage, 
        linkedin: 'https://www.linkedin.com/' 
      },
      { 
        name: 'Sarah Njeri', 
        role: 'Volunteer Mentor', 
        quote: 'The programs are practical, caring, and built around what families truly need.', image: womenImage, 
        linkedin: 'https://www.linkedin.com/' },
      { 
        name: 'James Otieno', 
        role: 'Community Partner', 
        quote: 'Working with WCDI has strengthened our community outreach and support systems.', image: youthImage, 
        linkedin: 'https://www.linkedin.com/' 
      }
    ],
    involvement: [
      { 
        icon: 'fa-heart', 
        title: 'Donate', 
        text: 'Fund programs that improve education, healthcare, and economic opportunity.', href: '/donate' 
      },
      { 
        icon: 'fa-user-plus', 
        title: 'Volunteer', 
        text: 'Offer your skills locally or remotely through WCDI projects.', 
        href: '/volunteer' 
      },
      { 
        icon: 'fa-handshake', 
        title: 'Partner', 
        text: 'Collaborate on programs, events, advocacy, and community outreach.', 
        href: '/contact' 
      }
    ]
  };
